...
func newDepositHandler(cliCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		panic("x/thorchain/client/rest newDepositHandler not implemented")
		// var req deposit
...
func newErrataTxHandler(cliCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		panic("x/thorchain/client/rest newErrataTxHandler not implemented")
		// var req newErrataTx
...
func newTssPoolHandler(cliCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		panic("x/thorchain/client/rest newTssPoolHandler not implemented")
		// var req newTssPool
...
func postTxsHandler(cliCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		panic("x/thorchain/client/rest postTxsHandler not implemented")
		// var req txHashReq
