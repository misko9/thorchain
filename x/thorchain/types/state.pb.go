...
// source: thorchain/v1/state.proto
...
func init() {
	proto.RegisterType((*ExampleData)(nil), "thorchain.v1.ExampleData")
}

func init() { proto.RegisterFile("thorchain/v1/state.proto", fileDescriptor_a06572813783339b) }
