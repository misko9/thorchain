...
var fileDescriptor_de249fd1e568560a = []byte{
	...
	0x58, 0x95, 0x94, 0x48, 0x7a, 0x7e, 0x7a, 0x3e, 0x58, 0x44, 0x1f, 0xc4, 0x82, 0x48, 0x2a, 0xcd,
	0x60, 0xe4, 0x12, 0x0a, 0x82, 0x68, 0x75, 0x46, 0xe8, 0x14, 0xf2, 0xe2, 0x62, 0x4f, 0x4c, 0x49,
	...
	0x30, 0x03, 0x84, 0xcc, 0xb8, 0xd8, 0x12, 0x73, 0xf3, 0x4b, 0xf3, 0x4a, 0x24, 0x98, 0xc0, 0x46,
	...
	0x10, 0x54, 0xb5, 0x93, 0xe7, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24,
	0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44, 0xe9,
	0xe3, 0x77, 0x08, 0x46, 0x08, 0x25, 0xb1, 0x81, 0x3d, 0x6b, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff,
	0xbd, 0x5f, 0xd1, 0x50, 0x4a, 0x01, 0x00, 0x00,
}
...
func (m *ReserveContributor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Amount) > 0 {
		...
		i = encodeVarintTypeReserveContributor(dAtA, i, uint64(len(m.Amount)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
