...
var fileDescriptor_df92b0a8f0156f4a = []byte{
	...
	,
}
...
func (m *ProtocolOwnedLiquidity) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RuneWithdrawn) > 0 {
		...
		i = encodeVarintTypePol(dAtA, i, uint64(len(m.RuneWithdrawn)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.RuneDeposited) > 0 {
		...
		i = encodeVarintTypePol(dAtA, i, uint64(len(m.RuneDeposited)))
		i--
		dAtA[i] = 0xa
	}
