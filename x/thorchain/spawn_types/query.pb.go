...
// source: thorchain/v1/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8295460cd91ceef, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8295460cd91ceef, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "thorchain.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "thorchain.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("thorchain/v1/query.proto", fileDescriptor_b8295460cd91ceef) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/thorchain.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/thorchain.v1.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "thorchain.v1.Query",
	...
	Metadata: "thorchain/v1/query.proto",
}
