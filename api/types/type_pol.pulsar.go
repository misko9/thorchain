...
type fastReflection_ProtocolOwnedLiquidity ProtocolOwnedLiquidity

func (x *ProtocolOwnedLiquidity) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ProtocolOwnedLiquidity)(x)
}

func (x *ProtocolOwnedLiquidity) slowProtoReflect() protoreflect.Message {
	mi := &file_types_type_pol_proto_msgTypes[0]
...
var _fastReflection_ProtocolOwnedLiquidity_messageType fastReflection_ProtocolOwnedLiquidity_messageType
var _ protoreflect.MessageType = fastReflection_ProtocolOwnedLiquidity_messageType{}

type fastReflection_ProtocolOwnedLiquidity_messageType struct{}

func (x fastReflection_ProtocolOwnedLiquidity_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ProtocolOwnedLiquidity)(nil)
}
func (x fastReflection_ProtocolOwnedLiquidity_messageType) New() protoreflect.Message {
	return new(fastReflection_ProtocolOwnedLiquidity)
}
func (x fastReflection_ProtocolOwnedLiquidity_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ProtocolOwnedLiquidity
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ProtocolOwnedLiquidity) Descriptor() protoreflect.MessageDescriptor {
	return md_ProtocolOwnedLiquidity
}
...
func (x *fastReflection_ProtocolOwnedLiquidity) Type() protoreflect.MessageType {
	return _fastReflection_ProtocolOwnedLiquidity_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ProtocolOwnedLiquidity) New() protoreflect.Message {
	return new(fastReflection_ProtocolOwnedLiquidity)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ProtocolOwnedLiquidity) Interface() protoreflect.ProtoMessage {
	return (*ProtocolOwnedLiquidity)(x)
}
...
func (x *fastReflection_ProtocolOwnedLiquidity) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message types.ProtocolOwnedLiquidity does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ProtocolOwnedLiquidity) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message types.ProtocolOwnedLiquidity does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ProtocolOwnedLiquidity) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in types.ProtocolOwnedLiquidity", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_ProtocolOwnedLiquidity) GetUnknown() protoreflect.RawFields {
...
func (x *fastReflection_ProtocolOwnedLiquidity) SetUnknown(fields protoreflect.RawFields) {
...
func (x *fastReflection_ProtocolOwnedLiquidity) IsValid() bool {
	return x != nil
}
...
func (x *fastReflection_ProtocolOwnedLiquidity) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ProtocolOwnedLiquidity)
		if x == nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProtocolOwnedLiquidity: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProtocolOwnedLiquidity: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var file_types_type_pol_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x65, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x6e, 0x42, 0x76, 0x0a, 0x09,
	0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x0c, 0x54, 0x79, 0x70, 0x65, 0x50,
	0x6f, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x6c, 0x61,
...
var (
	file_types_type_pol_proto_rawDescOnce sync.Once
	file_types_type_pol_proto_rawDescData = file_types_type_pol_proto_rawDesc
)

func file_types_type_pol_proto_rawDescGZIP() []byte {
	file_types_type_pol_proto_rawDescOnce.Do(func() {
		file_types_type_pol_proto_rawDescData = protoimpl.X.CompressGZIP(file_types_type_pol_proto_rawDescData)
	})
	return file_types_type_pol_proto_rawDescData
}

var file_types_type_pol_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_types_type_pol_proto_goTypes = []interface{}{
	(*ProtocolOwnedLiquidity)(nil), // 0: types.ProtocolOwnedLiquidity
}
var file_types_type_pol_proto_depIdxs = []int32{
...
func init() { file_types_type_pol_proto_init() }
func file_types_type_pol_proto_init() {
	if File_types_type_pol_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_types_type_pol_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtocolOwnedLiquidity); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_types_type_pol_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_types_type_pol_proto_goTypes,
		DependencyIndexes: file_types_type_pol_proto_depIdxs,
		MessageInfos:      file_types_type_pol_proto_msgTypes,
	}.Build()
	File_types_type_pol_proto = out.File
	file_types_type_pol_proto_rawDesc = nil
	file_types_type_pol_proto_goTypes = nil
	file_types_type_pol_proto_depIdxs = nil
}
