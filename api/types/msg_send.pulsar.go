...
func init() {
	...
	md_MsgSend = File_types_msg_send_proto.Messages().ByName("MsgSend")
...
func (x *MsgSend) slowProtoReflect() protoreflect.Message {
	mi := &file_types_msg_send_proto_msgTypes[0]
...
func (x *fastReflection_MsgSend) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.FromAddress) != 0 {
		value := protoreflect.ValueOfBytes(x.FromAddress)
		if !f(fd_MsgSend_from_address, value) {
			return
		}
	}
	if len(x.ToAddress) != 0 {
		value := protoreflect.ValueOfBytes(x.ToAddress)
...
func (x *fastReflection_MsgSend) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "types.MsgSend.from_address":
		return len(x.FromAddress) != 0
	case "types.MsgSend.to_address":
		return len(x.ToAddress) != 0
	case "types.MsgSend.amount":
		return len(x.Amount) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.MsgSend"))
		}
		panic(fmt.Errorf("message types.MsgSend does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgSend) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message types.MsgSend does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgSend) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "types.MsgSend.from_address":
		x.FromAddress = value.Bytes()
	case "types.MsgSend.to_address":
		x.ToAddress = value.Bytes()
	case "types.MsgSend.amount":
		lv := value.List()
...
func (x *fastReflection_MsgSend) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "types.MsgSend.from_address":
		panic(fmt.Errorf("field from_address of message types.MsgSend is not mutable"))
	case "types.MsgSend.to_address":
		panic(fmt.Errorf("field to_address of message types.MsgSend is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.MsgSend"))
		}
...
func (x *fastReflection_MsgSend) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in types.MsgSend", d.FullName()))
	}
	panic("unreachable")
}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.FromAddress = append(x.FromAddress[:0], dAtA[iNdEx:postIndex]...)
				if x.FromAddress == nil {
					x.FromAddress = []byte{}
				}
				iNdEx = postIndex
			case 2:
				...
				x.ToAddress = append(x.ToAddress[:0], dAtA[iNdEx:postIndex]...)
				if x.ToAddress == nil {
					x.ToAddress = []byte{}
				}
				iNdEx = postIndex
...
func (*MsgSend) Descriptor() ([]byte, []int) {
	return file_types_msg_send_proto_rawDescGZIP(), []int{0}
}
...
var file_types_msg_send_proto_rawDesc = []byte{
	0x0a, 0x14, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x6d, 0x73, 0x67, 0x5f, 0x73, 0x65, 0x6e, 0x64,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x1a, 0x1e, 0x63,
	...
	0x6f, 0x74, 0x6f, 0x22, 0x96, 0x02, 0x0a, 0x07, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x6e, 0x64, 0x12,
	0x54, 0x0a, 0x0c, 0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x50, 0x0a, 0x0a, 0x74, 0x6f, 0x5f, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x31, 0xfa, 0xde, 0x1f, 0x2d, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x74, 0x79, 0x70, 0x65,
	0x73, 0x2e, 0x41, 0x63, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x09, 0x74, 0x6f,
	...
	0x6f, 0x69, 0x6e, 0x73, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x76, 0x0a, 0x09,
	0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x0c, 0x4d, 0x73, 0x67, 0x53, 0x65,
...
var (
	file_types_msg_send_proto_rawDescOnce sync.Once
	file_types_msg_send_proto_rawDescData = file_types_msg_send_proto_rawDesc
)

func file_types_msg_send_proto_rawDescGZIP() []byte {
	file_types_msg_send_proto_rawDescOnce.Do(func() {
		file_types_msg_send_proto_rawDescData = protoimpl.X.CompressGZIP(file_types_msg_send_proto_rawDescData)
	})
	return file_types_msg_send_proto_rawDescData
}

var file_types_msg_send_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_types_msg_send_proto_goTypes = []interface{}{
	(*MsgSend)(nil),      // 0: types.MsgSend
	(*v1beta1.Coin)(nil), // 1: cosmos.base.v1beta1.Coin
}
var file_types_msg_send_proto_depIdxs = []int32{
	1, // 0: types.MsgSend.amount:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_types_msg_send_proto_init() }
func file_types_msg_send_proto_init() {
	if File_types_msg_send_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_types_msg_send_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_types_msg_send_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_types_msg_send_proto_goTypes,
		DependencyIndexes: file_types_msg_send_proto_depIdxs,
		MessageInfos:      file_types_msg_send_proto_msgTypes,
	}.Build()
	File_types_msg_send_proto = out.File
	file_types_msg_send_proto_rawDesc = nil
	file_types_msg_send_proto_goTypes = nil
	file_types_msg_send_proto_depIdxs = nil
}
