...
var file_types_query_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xef, 0x11, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12,
	...
	0x61, 0x69, 0x6e, 0x2f, 0x73, 0x6c, 0x69, 0x70, 0x73, 0x12, 0x77, 0x0a, 0x0b, 0x4f, 0x75, 0x74,
	...
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x46, 0x65,
	...
	0x6e, 0x64, 0x5f, 0x66, 0x65, 0x65, 0x73, 0x42, 0x78, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x2e, 0x74,
...
var file_types_query_proto_goTypes = []interface{}{
	...
	(*QueryPoolResponse)(nil),               // 20: types.QueryPoolResponse
	(*QueryPoolsResponse)(nil),              // 21: types.QueryPoolsResponse
	(*QueryDerivedPoolResponse)(nil),        // 22: types.QueryDerivedPoolResponse
	(*QueryDerivedPoolsResponse)(nil),       // 23: types.QueryDerivedPoolsResponse
	(*QueryLiquidityProviderResponse)(nil),  // 24: types.QueryLiquidityProviderResponse
	(*QueryLiquidityProvidersResponse)(nil), // 25: types.QueryLiquidityProvidersResponse
	(*QuerySaverResponse)(nil),              // 26: types.QuerySaverResponse
	(*QuerySaversResponse)(nil),             // 27: types.QuerySaversResponse
	(*QueryBorrowerResponse)(nil),           // 28: types.QueryBorrowerResponse
	(*QueryBorrowersResponse)(nil),          // 29: types.QueryBorrowersResponse
	(*QueryTradeUnitResponse)(nil),          // 30: types.QueryTradeUnitResponse
	(*QueryTradeUnitsResponse)(nil),         // 31: types.QueryTradeUnitsResponse
	(*QueryTradeAccountsResponse)(nil),      // 32: types.QueryTradeAccountsResponse
	(*QueryNodeResponse)(nil),               // 33: types.QueryNodeResponse
	(*QueryNodesResponse)(nil),              // 34: types.QueryNodesResponse
	(*QueryPoolSlipsResponse)(nil),          // 35: types.QueryPoolSlipsResponse
	(*QueryOutboundFeeResponse)(nil),        // 36: types.QueryOutboundFeeResponse
	(*QueryOutboundFeesResponse)(nil),       // 37: types.QueryOutboundFeesResponse
}
var file_types_query_proto_depIdxs = []int32{
	...
	20, // 20: types.Query.Pool:output_type -> types.QueryPoolResponse
	21, // 21: types.Query.Pools:output_type -> types.QueryPoolsResponse
	22, // 22: types.Query.DerivedPool:output_type -> types.QueryDerivedPoolResponse
	23, // 23: types.Query.DerivedPools:output_type -> types.QueryDerivedPoolsResponse
	24, // 24: types.Query.LiquidityProvider:output_type -> types.QueryLiquidityProviderResponse
	25, // 25: types.Query.LiquidityProviders:output_type -> types.QueryLiquidityProvidersResponse
	26, // 26: types.Query.Saver:output_type -> types.QuerySaverResponse
	27, // 27: types.Query.Savers:output_type -> types.QuerySaversResponse
	28, // 28: types.Query.Borrower:output_type -> types.QueryBorrowerResponse
	29, // 29: types.Query.Borrowers:output_type -> types.QueryBorrowersResponse
	30, // 30: types.Query.TradeUnit:output_type -> types.QueryTradeUnitResponse
	31, // 31: types.Query.TradeUnits:output_type -> types.QueryTradeUnitsResponse
	32, // 32: types.Query.TradeAccount:output_type -> types.QueryTradeAccountsResponse
	32, // 33: types.Query.TradeAccounts:output_type -> types.QueryTradeAccountsResponse
	33, // 34: types.Query.Node:output_type -> types.QueryNodeResponse
	34, // 35: types.Query.Nodes:output_type -> types.QueryNodesResponse
	35, // 36: types.Query.PoolSlip:output_type -> types.QueryPoolSlipsResponse
	35, // 37: types.Query.PoolSlips:output_type -> types.QueryPoolSlipsResponse
	36, // 38: types.Query.OutboundFee:output_type -> types.QueryOutboundFeeResponse
	37, // 39: types.Query.OutboundFees:output_type -> types.QueryOutboundFeesResponse
