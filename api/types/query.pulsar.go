...
var file_types_query_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x9b, 0x03, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79,
...
var file_types_query_proto_goTypes = []interface{}{
	...
	(*QueryPoolResponse)(nil),         // 4: types.QueryPoolResponse
	(*QueryPoolsResponse)(nil),        // 5: types.QueryPoolsResponse
	(*QueryDerivedPoolResponse)(nil),  // 6: types.QueryDerivedPoolResponse
	(*QueryDerivedPoolsResponse)(nil), // 7: types.QueryDerivedPoolsResponse
}
var file_types_query_proto_depIdxs = []int32{
	...
	4, // 4: types.Query.Pool:output_type -> types.QueryPoolResponse
	5, // 5: types.Query.Pools:output_type -> types.QueryPoolsResponse
	6, // 6: types.Query.DerivedPool:output_type -> types.QueryDerivedPoolResponse
	7, // 7: types.Query.DerivedPools:output_type -> types.QueryDerivedPoolsResponse
